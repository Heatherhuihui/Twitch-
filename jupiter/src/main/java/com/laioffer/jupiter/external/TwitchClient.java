...
public class TwitchClient {
    private static final String TOKEN = "Bearer z9q48ai7gr35cs4c6ormdrmje62lg2";
    private static final String CLIENT_ID = "x0rk9adtsubmlcxgt6mqq1z4dbpboh";
    ...
    private String searchTwitch(String url) throws TwitchException {
        ...
        // responseHandler to parse and return HTTP response body returned from twitch.
        ...
        try {
            ...
            request.setHeader("Authorizaton", TOKEN);
            request.setHeader("Client-Id", CLIENT_ID);
            return httpclient.execute(request, responseHandler);
        } catch (IOException e) {
            e.printStackTrace();
            throw new TwitchException("Failed to get result form Twitch API");
        } finally {
            try {
                httpclient.close();
            } catch (IOException e) {
